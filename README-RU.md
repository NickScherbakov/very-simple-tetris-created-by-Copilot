...
Для репозитория добавлен исходный аналог под экосистему **1С:Предприятие**. Исходники и инструкция по переносу находятся в каталоге [`1c-enterprise`](./1c-enterprise/README.md).
